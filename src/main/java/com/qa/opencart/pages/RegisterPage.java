...
//		eleUtil.selectDropDownByVisible(this.country, country);
//		try {
//			Thread.sleep(4000);
//		} catch (InterruptedException e) {
//			e.printStackTrace();
//		}
//		eleUtil.selectDropDownByVisible(this.regional, regional);
//		
		...
		String successMesg = 
				eleUtil.waitForElementVisible(registerSuccessMesg, Constants.DEFAULT_TIME_OUT).getText();
